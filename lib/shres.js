...
// res.add - adds event or error to output stream
  this.add = function (data) {
    ...
    if (this.req && this.req.body && this.req.body._pt) {
...
// res.flush - sends all events or errors
...
// SWD: should test if sending all at once is better for socket layer
  ...
  // res.notifyAdd - queues the real time messages so we can make them after save
  this.notifyAdd = function (uids, data, excludeIds) {
