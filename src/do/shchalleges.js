...
Challenges.prototype.addSend = function (toUid, game) {
  shlog.info("challenge.addSend:", toUid, game);
...
Challenges.prototype.removeRecieved = function (chId) {
  shlog.info("challenge.removeRecieved:", chId);
